...
| `runbooks/10-os-capability.check.yaml` | `os.capability` | 1 |
...
| `runbooks/24-os-hostname.check.yaml` | `os.hostname` | 3 |
| `runbooks/25-os-hosts.check.yaml` | `os.hosts` | 4 |
...
| `runbooks/30-os-limits.check.yaml` | `os.limits` | 1 |
| `runbooks/31-local.check.yaml` | `local` | 1 |
| `runbooks/32-system-log.check.yaml` | `system.log` | 2 |
| `runbooks/33-os-login.check.yaml` | `os.login` | 3 |
...
| `runbooks/42-os-package.check.yaml` | `os.package` | 27 |
| `runbooks/43-pki.check.yaml` | `security.pki.trust` | 3 |
| `runbooks/44-os-platform.check.yaml` | `os.platform` | 1 |
