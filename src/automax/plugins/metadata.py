...
PARAMETERS: dict[str, dict[str, Any]] = {
    ...
    "required_match_count": {"type": "integer", "description": "Expected number of regex matches."},
    ...
    "min_free_inodes": {"type": "integer", "min": 0, "description": "Minimum free inode count."},
...
RESULT_FIELD_OVERRIDES: dict[str, dict[str, str]] = {
    ...
    "storage.usage.disk.check": {"stdout": "df output used for the disk usage check."},
    "storage.usage.inode.check": {"stdout": "df -i output used for the inode usage check."},
    "fs.dir.check": {"data.exists": "Boolean directory existence result.", "data.path": "Checked remote path.", "data.type": "Expected filesystem type."},
    "fs.file.check": {"data.exists": "Boolean regular-file existence result.", "data.path": "Checked remote path.", "data.type": "Expected filesystem type."},
    "fs.symlink.check": {"data.exists": "Boolean symlink existence result.", "data.is_symlink": "Whether the path is a symlink.", "data.target": "Literal symlink target when present.", "data.resolved_target": "Resolved target path used for target existence checks.", "data.target_exists": "Whether the resolved target currently exists.", "data.broken": "Whether the symlink target is currently missing.", "data.matches": "Whether the literal symlink target matches the requested target when provided."},
    "fs.symlink.get": {"data.exists": "Boolean path existence result.", "data.is_symlink": "Whether the path is a symlink.", "data.target": "Literal symlink target when present.", "data.resolved_target": "Resolved target path used for target existence checks.", "data.target_exists": "Whether the resolved target currently exists.", "data.broken": "Whether the symlink target is currently missing."},
    ...
    "fs.path.stat": {"data.exists": "Boolean path existence result.", "data.size": "Path size in bytes.", "data.mode": "POSIX mode.", "data.owner": "Owner name.", "data.group": "Group name."},
    "fs.permission.mode.get": {"data.mode": "Current POSIX mode."},
    "fs.permission.mode.check": {"data.exists": "Whether the remote path exists.", "data.current_mode": "Current POSIX mode when present.", "data.matches": "Whether the current mode matches the requested mode."},
    "fs.permission.owner.get": {"data.owner": "Current owner name.", "data.group": "Current group name."},
    "fs.permission.owner.check": {"data.exists": "Whether the remote path exists.", "data.current_owner": "Current owner name when present.", "data.current_group": "Current group name when present.", "data.matches": "Whether current owner/group matches requested values."},
    "fs.file.line.check": {"data.exists": "Whether the remote file exists.", "data.line_present": "Whether the exact line is present.", "data.matches": "Whether line presence matches the requested state."},
    ...
    "network.http.check": {"data.status": "HTTP response status code.", "data.body": "Decoded response body.", "data.matches": "Whether the HTTP response matched the expected status and body predicate."},
    "network.http.wait": {"data.status": "HTTP response status code.", "data.body": "Decoded response body."},
    "network.connectivity.port.wait": {"data.host": "Checked host.", "data.port": "Checked TCP port."},
    "network.connectivity.port.check": {"data.host": "Checked host.", "data.port": "Checked TCP/UDP port.", "data.reachable": "Whether the remote target can reach the port."},
    ...
    "identity.user.check": {"data.exists": "Whether the remote user exists.", "data.name": "Checked username."},
    "identity.group.check": {"data.exists": "Whether the remote group exists.", "data.name": "Checked group name."},
...
PLUGIN_EXAMPLES: dict[str, str] = {
    ...
    "storage.usage.disk.check": "use: storage.usage.disk.check\nwith:\n  path: /var\n  min_free_mb: 1024\n  max_used_percent: 85\n  sudo: true",
    "storage.usage.inode.check": "use: storage.usage.inode.check\nwith:\n  path: /var\n  max_used_percent: 85\n  sudo: true",
