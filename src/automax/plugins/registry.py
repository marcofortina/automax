...
def build_builtin_registry(extra_plugin_paths: Iterable[str] = ()) -> PluginRegistry:
    ...
    from automax.plugins.firewall import (
        ...
        ExtendedFirewalldPortPlugin,
        ExtendedFirewalldRichRulePlugin,
        ExtendedFirewalldServicePlugin,
    ...
    from automax.plugins.hardening import AuthselectProfilePlugin, ExtendedSshdConfigPlugin, LoginDefsPlugin, PasswordPolicyPlugin
