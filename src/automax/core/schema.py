...
def _substep_schema() -> Dict[str, Any]:
    return {
        ...
        "oneOf": [
            ...
            {"required": ["if"]},
            {"required": ["switch"]},
            {"required": ["retry"], "not": {"anyOf": [{"required": ["use"]}, {"required": ["plugin"]}]}},
            {"required": ["for", "in", "do"]},
            {"required": ["set"]},
            {"required": ["let"]},
            {"required": ["echo"]},
        ...
        "properties": {
            ...
            "register": {"type": ["string", "object"], "additionalProperties": {"type": "string"}},
            ...
            "switch": {},
            "case": {"type": "object", "additionalProperties": {"type": "array", "items": {"type": "object", "additionalProperties": True}}},
            ...
            "message": {},
            "fail": {},
            "try": {"type": "array", "items": {"type": "object", "additionalProperties": True}},
            "rescue": {"type": "array", "items": {"type": "object", "additionalProperties": True}},
            "always": {"type": "array", "items": {"type": "object", "additionalProperties": True}},
            "block": {"type": "array", "items": {"type": "object", "additionalProperties": True}},
            "break": {},
            "continue": {},
        },
    }
